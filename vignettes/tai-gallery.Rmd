...
vignette: >
  %\VignetteIndexEntry{tai-gallery}
...
library(myTAI); library(S7); library(ggplot2)
...
```{r message = FALSE, warning = FALSE, fig.height=3, fig.width=5, fig.alt="plot_cullen_frey function output for stat_flatline_test", dev.args = list(bg = 'transparent'), fig.align='center'}
...
```{r message = FALSE, warning = FALSE, results = FALSE, fig.height=4, fig.width=6, fig.alt="plot_gene_heatmap function output", dev.args = list(bg = 'transparent'), fig.align='center'}
...
myTAI::plot_sample_space(example_phyex_set)
myTAI::plot_sample_space(example_phyex_set, colour_by = "TXI")
```
...
```{r message = FALSE, warning = FALSE, results = FALSE, fig.height=3, fig.width=3, fig.alt="plot_mean_var function output by strata", dev.args = list(bg = 'transparent'), fig.align='center'}
