...
example_sc <- myTAI::load_example_phyex_set_sc()
```
...
print(myTAI::available_identities(example_sc))
```
...
example_sc <- myTAI::set_identity_colours(example_sc, "day", day_colors)
example_sc <- myTAI::set_identity_colours(example_sc, "condition", condition_colors)
example_sc <- myTAI::set_identity_colours(example_sc, "groups", group_colors)
```

#### Single-cell signature plots

```{r message = FALSE, warning = FALSE, results = FALSE, fig.height=4, fig.width=6, fig.alt="plot_signature single-cell basic", dev.args = list(bg = 'transparent'), fig.align='center', eval = requireNamespace("Seurat", quietly = TRUE)}
# Basic signature plot showing TXI distribution across cell types
myTAI::plot_signature(example_sc)
```

```{r message = FALSE, warning = FALSE, results = FALSE, fig.height=4, fig.width=6, fig.alt="plot_signature single-cell without individual cells", dev.args = list(bg = 'transparent'), fig.align='center', eval = requireNamespace("Seurat", quietly = TRUE)}
# Plot without showing individual cells (just means)
myTAI::plot_signature(example_sc, show_reps = FALSE)
```

```{r message = FALSE, warning = FALSE, results = FALSE, fig.height=4, fig.width=6, fig.alt="plot_signature single-cell by day", dev.args = list(bg = 'transparent'), fig.align='center', eval = requireNamespace("Seurat", quietly = TRUE)}
# Plot TXI distribution by developmental day instead of cell type
myTAI::plot_signature(example_sc, primary_identity = "day", show_p_val = FALSE)
```

```{r message = FALSE, warning = FALSE, results = FALSE, fig.height=4, fig.width=6, fig.alt="plot_signature single-cell by condition", dev.args = list(bg = 'transparent'), fig.align='center', eval = requireNamespace("Seurat", quietly = TRUE)}
# Plot TXI distribution by experimental condition
myTAI::plot_signature(example_sc, primary_identity = "condition", show_p_val=FALSE)
```

You can use a secondary identity for either coloring or faceting to create more informative plots:

```{r message = FALSE, warning = FALSE, results = FALSE, fig.height=4, fig.width=8, fig.alt="plot_signature single-cell with secondary coloring", dev.args = list(bg = 'transparent'), fig.align='center', eval = requireNamespace("Seurat", quietly = TRUE)}
...
```{r message = FALSE, warning = FALSE, results = FALSE, fig.height=6, fig.width=10, fig.alt="plot_signature single-cell with faceting", dev.args = list(bg = 'transparent'), fig.align='center', eval = requireNamespace("Seurat", quietly = TRUE)}
...
```{r message = FALSE, warning = FALSE, results = FALSE, fig.height=8, fig.width=10, fig.alt="plot_gene_heatmap single-cell", dev.args = list(bg = 'transparent'), fig.align='center', eval = requireNamespace("Seurat", quietly = TRUE)}
# Gene heatmap for single-cell data (aggregated by cell type)
myTAI::plot_gene_heatmap(example_sc, top_p = 0.1, cluster_rows=TRUE)
```

```{r message = FALSE, warning = FALSE, results = FALSE, fig.height=8, fig.width=12, fig.alt="plot_gene_heatmap single-cell with individual cells", dev.args = list(bg = 'transparent'), fig.align='center', eval = requireNamespace("Seurat", quietly = TRUE)}
# Gene heatmap showing individual cells (subsampled)
myTAI::plot_gene_heatmap(example_sc, show_reps = TRUE, max_cells_per_type = 10, top_p = 0.05, cluster_rows=TRUE)
```

```{r message = FALSE, warning = FALSE, results = FALSE, fig.height=8, fig.width=12, fig.alt="plot_gene_heatmap single-cell grouped by day", dev.args = list(bg = 'transparent'), fig.align='center', eval = requireNamespace("Seurat", quietly = TRUE)}
# Change identity to "day" and plot heatmap grouped by developmental time
example_sc_by_day <- myTAI::set_identities(example_sc, "day")
