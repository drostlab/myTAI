...
The taxonomic classifications should be the same between `taxonomy(..., db = "ncbi")` and `GenEra` output (since it uses NCBI taxdump as input). But it should be noted that the recent updates to NCBI taxonomy has meant that the highest order ranks (cellular root, domain, kingdom etc.) may differ.
:::
