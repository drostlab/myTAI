...
The `taxonomy()` function implemented in `myTAI` relies on the powerful package [taxize](http://cran.r-project.org/web/packages/taxize/index.html).
...
These results allow us to choose `subject` organisms for [Divergence Stratigraphy](https://github.com/HajkD/orthologr/blob/master/vignettes/divergence_stratigraphy.Rmd).
