...
Again, we retrieve the _D. rerio_ specific taxonomy represented by PS1-14 using the `taxonomy()` function (see [Introduction](Introduction.html) and [Taxonomy](Taxonomy.html) for details).
