...
### The `EnrichmentTest()` Function

We implemented the helper function `EnrichmentTest()` to speed up accessing P-values and
the enrichment matrix returned by an enrichment analysis.

```{r,eval = FALSE}
EnrichmentTest(Drerio.PhyloMap,
               test.set     = Drerio.Brain.Genes[ , 1],
               measure      = "log-foldchange",
               use.only.map = TRUE)
```
...
$enrichment.matrix
         BG_Set     Test_Set
1  -0.001132832  0.007668216
2   0.023733936 -0.172380714
3  -0.040879607  0.250587496
4  -0.048920465  0.294399729
5  -0.114888949  0.603817643
6   0.008678915 -0.060350168
7  -0.062948352  0.367240944
8   0.115630474 -1.206210187
9  -0.007353969  0.048964218
10 -0.031971192  0.200141519
11  0.039742253 -0.303363314
12 -0.002418079  0.016311853
13  0.101449988 -0.984621732
14  0.098211044 -0.938724783
```
...
when it is based on the functional annotation of the `test.set`. The [Functional Annotation](https://github.com/HajkD/biomartr/blob/master/vignettes/Functional_Annotation.Rmd) vignette of our [biomartr](https://github.com/HajkD/biomartr) package will show you how to retrieve functional
