...
```{r message=FALSE, warning=FALSE, fig.alt="plot signature"}
...
```{r message=FALSE, warning=FALSE, fig.alt="plot expression by PS"}
...
```{r message=FALSE, warning=FALSE, fig.alt="plot mean expression"}
...
```{r message=FALSE, warning=FALSE, fig.height=5, fig.alt="plot group diffs"}
