...
test_that("PhyloExpressionSet properties work", {
    ...
    expect_equal(ncol(example_phyex_set@pTXI), example_phyex_set@num_identities)
...
test_that("pTXI calculation works", {
    ptxi_matrix <- pTXI(example_phyex_set@expression_collapsed, example_phyex_set@strata)
