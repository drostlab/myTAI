...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Eigen::MatrixXd >::type count_matrix(count_matrixSEXP);
    Rcpp::traits::input_parameter< Eigen::VectorXd >::type strata_vector(strata_vectorSEXP);
