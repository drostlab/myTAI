...
#' For example, module = list(early = 1:2, mid = 3:5, late = 6:7) devides a dataset 
...
#' shall be performed to test the goodness of fit of the approximated distribution.
#' @param parallel a boolean value specifying whether goodness of fit computations 
#' shall be performed in parallel using the \code{doMC} package.
...
#'
#' (2) The mean TAI value for each of the three modules T_early, T_mid, and T_late are computed. 
#'
...
#' approximated by a Gaussian distribution with method of moments estimated parameters returned by \code{fitdistrplus::fitdist}, 
...
#' This plot illustrates which distributions seems plausible to fit the resulting permutation vector D_min. 
...
#' The corresponding parameters are estimated by \emph{moment matching estimation} using the fitdistrplus::fitdist() function.
#'
...
#' This allows to quantify the permutation biase and their implications on the goodness of fit.
...
#'
#'
#' # perform the reductive hourglass test for a DivergenceExpressionSet
#' # here the prior biological knowledge is that stages 1-2 correspond to module 1 = early,
#' # stages 3-5 to module 2 = mid (phylotypic module), and stages 6-7 correspond to
#' # module 3 = late
#' ReductiveHourglassTest(DivergenceExpressionSetExample,
#'                        modules = list(early = 1:2, mid = 3:5, late = 6:7), 
#'                        permutations=1000)
#' 
