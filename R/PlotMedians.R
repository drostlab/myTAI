...
#' @details 
#' 
#' This plot may be useful to compare the absolute median expression        
...
#' @return a plot showing median expression profiles of each age category.
...
PlotMedians <- function(ExpressionSet,
                      Groups     = NULL,
                      legendName = "age",
                      xlab = "Ontogeny",
