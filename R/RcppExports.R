...
cpp_bootMatrix_old <- function(ExpressionMatrix, AgeVector, permutations) {
    .Call(`_myTAI_cpp_bootMatrix_old`, ExpressionMatrix, AgeVector, permutations)
}
...
cpp_pMatrix_old <- function(ExpressionSet, AgeVector) {
    .Call(`_myTAI_cpp_pMatrix_old`, ExpressionSet, AgeVector)
}
